...
<div class="container text-center">
   <h1>No tienes permisos para editar Producto, contactate con el Administrador</h1> 
</div>
@else
...
<div class="row">
 ...
 <ul class="nav-horizontal text-center">
   ...
   <a class="btn btn-primary waves-effect waves-light" href="/dafer/crear-usuario"><i class="fa fa-user-plus"></i> Crear Usuario</a>
                                  ...
                                  {{ Form::open(array('method' => 'POST','class' => 'form-horizontal','id' => 'defaultForm1', 'url' => array('/dafer/editarproducto',$producto->id))) }}
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                {{Form::text('producto', $producto->producto, array('class' => 'form-control','placeholder'=>'Ingrese número identificación' ))}}
                                            </div>
                                        </div>
